        ...
        <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="border border-[var(--border)] rounded-lg p-6">
                <div className="flex items-baseline justify-between mb-4">
                  <h4 className="font-serif text-xl text-[var(--foreground)]">Standard</h4>
                  <span className="text-[var(--primary)] font-medium">£120/week</span>
                </div>
              ...
              <div className="border-2 border-[var(--primary)] rounded-lg p-6 relative">
                <div className="absolute -top-3 left-6 bg-[var(--primary)] text-[var(--primary-foreground)] text-xs px-3 py-1 rounded-full">
                  Recommended
                </div>
                <div className="flex items-baseline justify-between mb-4">
                  <h4 className="font-serif text-xl text-[var(--foreground)]">Premium</h4>
                  <span className="text-[var(--primary)] font-medium">£160/week</span>
                </div>
          ...
          <div className="bg-[var(--card)] rounded-lg p-8 md:p-10 shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="border border-[var(--border)] rounded-lg p-6">
                <div className="flex items-baseline justify-between mb-4">
                  <h4 className="font-serif text-xl text-[var(--foreground)]">Half-Day Workshop</h4>
                  <span className="text-[var(--primary)] font-medium">£950</span>
                </div>
                <p className="text-sm text-[var(--muted-foreground)] mb-4">3 hours</p>
                <ul className="space-y-3 text-sm text-[var(--muted-foreground)]">
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--primary)] mt-1">•</span>
              ...
              <div className="border border-[var(--border)] rounded-lg p-6">
                <div className="flex items-baseline justify-between mb-4">
                  <h4 className="font-serif text-xl text-[var(--foreground)]">Summer Padelboard</h4>
                  <span className="text-[var(--primary)] font-medium">£950</span>
                </div>
                <p className="text-sm text-[var(--muted-foreground)] mb-4">Up to 8 participants</p>
                <ul className="space-y-3 text-sm text-[var(--muted-foreground)]">
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--primary)] mt-1">•</span>
          ...
          <div className="bg-[var(--card)] rounded-lg p-8 md:p-10 shadow-sm">
            ...
            <div className="max-w-md">
              <div className="border border-[var(--border)] rounded-lg p-6">
                <div className="flex items-baseline justify-between mb-4">
                  <h4 className="font-serif text-xl text-[var(--foreground)]">1:1 Remote</h4>
                  <span className="text-[var(--primary)] font-medium">£100/week</span>
                </div>
                <ul className="space-y-3 text-sm text-[var(--muted-foreground)]">
                  <li className="flex items-start gap-2">
                    <span className="text-[var(--primary)] mt-1">•</span>
